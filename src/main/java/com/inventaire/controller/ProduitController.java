...
public class ProduitController {
    ...
    public String getProduitInterfaceEmployee(Model model){
        ...
        model.addAttribute("emplacements",produiService.findAllProduit());
    ...
    public String saveUser(@RequestParam("file") MultipartFile file,
        ...
        produiService.registerProduit(file,nom_produit,titre,description,code,categorie,emplacement,employee,
