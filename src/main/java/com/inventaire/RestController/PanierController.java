...
public class PanierController {
    ...
    @GetMapping("/addProduitToPanier/{id_produit}/{id}")
    public void addProduitToPanier(@PathVariable int id_produit,@PathVariable int id){
    ...
    @GetMapping("/allProduitsNonCommandes/{id}")
    public List<Produit> AllProduitNonCommandes(@PathVariable Long id){
        int cle=0;
