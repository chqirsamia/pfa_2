(function($) {
    ...
    $(".annule").click(function(e) {
        e.preventDefault();
        var urlannul = url + "/deleteAllProduitsCommandes";
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var k = 0; k < numdelete; k++) {
                ...
                deletep[k].addEventListener("click", (function(k){
                    return function() {
                        var id =  document.getElementsByClassName('delete')[k].getAttribute("value");
                        console.log('value = '+ id);
                        var urlD = url + "/deleteProduitsCommandes/"+id;
